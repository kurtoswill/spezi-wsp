            ...
            <div className="bg-white rounded-3xl p-10 w-full max-w-md shadow-2xl border border-gray-200">
                ...
                <div className="text-center mt-8 space-y-4">
                    <p className="text-sm text-gray-600">
                        <a href="/forgot-password" className="text-[#6EB1D6] hover:text-[#232C4F] font-medium transition-colors">
                            Forgot your password?
                        </a>
                    </p>
                    <p className="text-sm text-gray-600">
                        Don't have an account?{' '}
                        <a href="/signup" className="text-[#6EB1D6] hover:text-[#232C4F] font-medium transition-colors">
                            Sign up here
                        </a>
                    </p>
                </div>
