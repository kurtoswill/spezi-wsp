      ...
      <div className="fixed inset-0 bg-black bg-opacity-75 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-2xl max-w-md w-full p-6 relative">
          ...
          <div className="text-center">
            <h3 className="text-xl font-semibold text-[#232C4F] mb-3">Under Development</h3>
            <p className="text-[#232C4F] mb-6 leading-relaxed">
              This project is still under development. Some features may not be working correctly or may be incomplete.
              Thank you for your patience as we continue to improve Spezi!
            </p>
            <button
                onClick={onClose}
